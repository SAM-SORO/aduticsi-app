    ...
    <main className="min-h-dvh flex items-center justify-center p-4 relative overflow-hidden bg-slate-50 font-sans">
      ...
      <div className="w-full max-w-[500px] z-10 flex flex-col gap-6">
        <div className="text-center space-y-2 flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Mot de passe oublié</h1>
        ...
        <div className="bg-white rounded-3xl border border-slate-200/60 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.08)] backdrop-blur-xl relative overflow-hidden">
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 focus:outline-none focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:border-aduti-primary transition-all text-sm font-medium shadow-inner"
                  />
                </div>
              </div>
              ...
              <button
                disabled={isPending}
                className="w-full flex justify-center items-center gap-3 py-4 px-6 rounded-2xl shadow-xl shadow-blue-100 text-sm font-bold text-white bg-aduti-primary hover:bg-aduti-primary-hover focus:outline-none transition-all active:scale-[0.98] uppercase tracking-widest disabled:opacity-50"
              >
                {isPending ? (
