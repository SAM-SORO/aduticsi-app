        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="bg-aduti-primary hover:bg-aduti-primary-hover text-white px-6 h-12 rounded-xl shadow-lg shadow-blue-100 transition-all active:scale-95 gap-2">
