...
export default function AboutPage() {
  ...
  return (
    <main className="flex-1 w-full overflow-x-hidden">
            ...
            <div className="flex items-center gap-8 pt-2" style={{ animationDelay: "300ms" }}>
              {[
                ...
                <div key={s.val} className="text-center">
                  <div className="text-2xl font-semibold tracking-tight text-slate-900">{s.val}</div>
      ...
      <section id="notre-histoire" className="relative overflow-hidden scroll-mt-20 bg-white px-4 py-24 md:py-32">
                ...
                <div className="h-full bg-white/40 backdrop-blur-sm p-10 rounded-3xl border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)] transition-all duration-700 hover:shadow-[0_40px_80px_rgba(0,0,0,0.08)] hover:-translate-y-4 group-hover:bg-white">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-baseline gap-3">
                      <span className={`text-4xl font-bold ${chapter.color} tracking-tighter`}>{chapter.year}</span>
      ...
      <section className="relative overflow-hidden border-y border-slate-200 bg-slate-50 px-4 py-20 md:py-28">
        ...
        <div className="max-w-7xl mx-auto">
          <FadeInScroll className="relative mb-32 flex flex-col md:flex-row items-start md:items-end justify-between gap-16 md:gap-24">
            ...
            <div className="absolute -top-16 -left-8 text-[10rem] md:text-[16rem] font-[family-name:var(--font-display)] font-bold text-slate-900/[0.03] select-none pointer-events-none z-0 leading-none">
              STIC
            </div>
              ...
              <div className="relative z-10 space-y-12">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 hover:shadow-xl transition-all">
                    <div className="text-[#c2185b] text-2xl font-bold mb-1">INFO</div>
                  ...
                  <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 hover:shadow-xl transition-all">
                    <div className="text-slate-400 text-2xl font-bold mb-1">EIT</div>
      ...
      <section className="bg-white px-4 py-24 text-center md:py-32">
